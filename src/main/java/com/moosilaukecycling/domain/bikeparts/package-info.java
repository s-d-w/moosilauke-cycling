...
/* The factories are setup to create parts by country. These could easily be made to make parts
   by brand with BrandFactories instead of CountryFactories. By doing so by brand, you'd want
   to create brand specific parts such as SpecializedTarmac implements Frame which could
   implement specific functionality such as a call to a tightenProprietaryBolts() in its repair
